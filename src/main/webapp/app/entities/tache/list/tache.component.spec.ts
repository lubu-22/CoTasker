...
describe('Tache Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tache', component: TacheComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taches?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
