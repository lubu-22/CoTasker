...
export class TacheComponent implements OnInit {
  ...
  trackId(_index: number, item: ITache): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITache[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
