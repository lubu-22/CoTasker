...
describe('Fichier Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fichier', component: FichierComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fichiers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
