...
import stage.a2sys.gestion.repository.ClientRepository;
import stage.a2sys.gestion.service.ClientService;
...
/**
 * REST controller for managing {@link stage.a2sys.gestion.domain.Client}.
 */
@RestController
@RequestMapping("/api")
